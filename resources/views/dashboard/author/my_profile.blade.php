                            ...
                            <div class="profile-head">
                                ...
                                <div class="profile-info">
									<div class="profile-photo">
										<img src="{{config('app.url')}}acara/images/profile/profile.png" class="img-fluid rounded-circle" alt="">
									</div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="profile-interest mb-5">
                                    ...
                                    <div class="row mt-4 sp4" id="lightgallery">
										<a href="images/profile/2.jpg" data-exthumbimage="images/profile/2.jpg" data-src="{{config('app.url')}}acara/images/profile/2.jpg" class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
											<img src="{{config('app.url')}}acara/images/profile/2.jpg" alt="" class="img-fluid">
										</a>
										<a href="images/profile/3.jpg" data-exthumbimage="images/profile/3.jpg" data-src="{{config('app.url')}}acara/images/profile/3.jpg" class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
											<img src="{{config('app.url')}}acara/images/profile/3.jpg" alt="" class="img-fluid">
										</a>
										<a href="images/profile/4.jpg" data-exthumbimage="images/profile/4.jpg" data-src="{{config('app.url')}}acara/images/profile/4.jpg" class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
											<img src="{{config('app.url')}}acara/images/profile/4.jpg" alt="" class="img-fluid">
										</a>
										<a href="images/profile/3.jpg" data-exthumbimage="images/profile/3.jpg" data-src="{{config('app.url')}}acara/images/profile/3.jpg" class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
											<img src="{{config('app.url')}}acara/images/profile/3.jpg" alt="" class="img-fluid">
										</a>
                                ...
                                <div class="profile-news">
                                    ...
                                    <div class="media pt-3 pb-3">
                                        <img src="{{config('app.url')}}acara/images/profile/5.jpg" alt="image" class="mr-3 rounded" width="75">
                                    ...
                                    <div class="media pt-3 pb-3">
                                        <img src="{{config('app.url')}}acara/images/profile/6.jpg" alt="image" class="mr-3 rounded" width="75">
                                        <div class="media-body">
                                            <h5 class="m-b-5"><a href="post-details.html" class="text-black">Collection of textile samples</a></h5>
                                            <p class="mb-0">I shared this on my fb wall a few months back, and I thought.</p>
                                        </div>
                                    ...
                                    <div class="media pt-3 pb-3">
                                        <img src="{{config('app.url')}}acara/images/profile/7.jpg" alt="image" class="mr-3 rounded" width="75">
                                        <div class="media-body">
                                            <h5 class="m-b-5"><a href="post-details.html" class="text-black">Collection of textile samples</a></h5>
                                            <p class="mb-0">I shared this on my fb wall a few months back, and I thought.</p>
                                        </div>
